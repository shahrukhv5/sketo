...
const CertificatesCard = ({ title, description, price, hours }) => {
  return (
...
const CertificatesCards = () => {
  const bootcamps = [
    ...
    {
      title: "Motion Graphics Certificate",
      description:
    ...
    <div className="bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-10 text-center">
          Featured Design Bootcamps & Certificates
        </h2>
        {/* Cards Grid */}
